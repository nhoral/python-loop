...
raptorStrikeOffCooldown = Predicate('raptor_strike_cooldown', False)
arcaneShotOffCooldown = Predicate('arcane_shot_cooldown', False)
...
serpentStingOff = Predicate('serpent_sting', False)
...
raptorStrikeIfInMelee = Macro([ raptorStrikeOffCooldown, inMeleeRange ], "e")
castArcaneShot = Macro([ arcaneShotOffCooldown, notInMeleeRange], "r")
casthuntersMarkIfOff = Macro([huntersMarkOff], "9")
castserpentStingIfOff = Macro([ serpentStingOff ], "f")
interuptTargetCastMelee = Macro([ warstompOffCooldown, enemyCastingSpell, inMeleeRange ], "2")

# macro order, first macro to be true picks the key to press
macros = [
    
    interuptTargetCastMelee,
    raptorStrikeIfInMelee,
    #casthuntersMarkIfOff,
    #castserpentStingIfOff,
    castDefaultAttack
